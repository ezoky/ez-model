...
/**
  ...
  * @since 0.2.0
  */
object PlantUMLTestFixture {

  val useCaseDiagram = PlantUMLDiagram(
    packages = Set(
      PlantUMLPackage(
        "package 1",
        packages = Set(
          PlantUMLPackage(
            ...
            relations = Set(
              PlantUMLOrientedLink(PlantUMLActor("Actor 1"), PlantUMLUseCase("Use case 1"))
            )
          )
        ),
